...
class UpdateAccountDataPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final completeDataProvider = Provider.of<CompleteDataProvider>(context,
      listen: false,
    );
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(LanguageProvider.translate("settings", "update_profile")),
        ),
        body: Form(
          key: completeDataProvider.updateAccountDataFormKey,
          child: Column(
            children: [
              Expanded(
                      ...
                      children: [
                        ...
                        Center(
                          child: UploadImageWidget(
                            fromAuth: completeDataProvider.fromAuthRegister,
                          ),
                        ),
                        SizedBox(height: 2.h),
                        ListTextFieldWidget(
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: ButtonWidget(
                              text: "save",
                              onTap: () {
                                if (completeDataProvider.updateAccountDataFormKey.currentState!.validate()) {
                                  completeDataProvider.updateProfileButton(
