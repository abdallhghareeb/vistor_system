...
import '../widget/image/pick_image_page.dart';
...
Future<XFile?> takeImage() async {
  final ImagePicker picker = ImagePicker();
  return await picker.pickImage(source: ImageSource.camera, imageQuality: 100);
}
